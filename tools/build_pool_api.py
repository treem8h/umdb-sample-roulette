...
BAD = re.compile(
    ...
    # EDM/bass-music (audio distorto di natura) + tutorial batteria/gear/videogame — NON tocca dub/riddim reggae
    r'monster drop|cinematic drop|\bedm\b|dubstep|brostep|\bhardstyle\b|hard techno|bass house|festival trap|big room|'
    r'course preview|sneak preview|\bmasterclass\b|drum lessons?|\bdrumming\b|drum setup|sheet music|\brudiments?\b|'
    r'\bvst3?\b|\bplugin\b|\bpreset\b|sound ?pack|unboxing|gear (demo|review)|'
    r'\bnintendo\b|playstation|\bxbox\b|switch 2|switch review|text adventure|'
